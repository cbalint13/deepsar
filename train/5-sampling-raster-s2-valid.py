...
# radar
s1_rst = gdal.Open("work/sentinel1-valid.vrt")
s1_src = "work/limits/S1A_IW_SLC__1SDV_20160708T043658_20160708T043726_012052_012A1A_D5C6.shp"

# image
s2_rst = gdal.Open("work/sentinel2-valid.vrt")
s2_src = "work/limits/S2A_OPER_MTD_L1C_TL_EPA__20160707T153315_A000991.shp"
  ...
  for a in range(0,360,360):
    ...
    if ( ( patch.Within( s1geom ) ) and
      ...
      if ((in_idx >= h5samples) or (h5_idx == 0)):
        ...
        h5f = h5py.File('./hdf5-test/dataset-%s.h5' % h5_id)
